//拉框放大
Ext.Cat.AjaxMap.ZoominTool = function (config) {
    Ext.Cat.AjaxMap.ZoominTool.superclass.constructor.call(this, config);
}
Ext.extend(Ext.Cat.AjaxMap.ZoominTool, Ext.Cat.AjaxMap.AbstractTool, {
    cursorStyle: "url('../../../maps/zoomin.cur'),pointer",
    selected: false,
    alt: '拉框放大',
    ...
    mouseUpHandler: function (e, toolbar) {
        if (this.mouseDownPixel && this.mouseMovePixel) {
            ...
            this.zoomToExtent(toolbar.model, rect, toolbar.container.body, "zoomin"); //this.mapDiv.parentNode
