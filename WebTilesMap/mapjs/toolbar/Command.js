...
Abstract.Command.prototype = {
    initialize: function(id,img1,img2,img3,pos,left,top,width,height){
        ...
        this.id = id;
        this.img_normal = Ext.Cat.MapConfig.ImageBaseDir + 'mapTools/' + img1;
        this.img_over = Ext.Cat.MapConfig.ImageBaseDir + 'mapTools/' + img2;
        this.img_down = Ext.Cat.MapConfig.ImageBaseDir + 'mapTools/' + img3;
        this.position = pos;
...
PrevCmd.prototype = Object.extend(new Abstract.Command(), {      
    ...
    cmd_clickHandler: function(cmd, model, mapDiv){
        ...
        if(model.curIndex >0 && model.curIndex <= model.traceIndex - 1){
            ...
            $('sliderbar_' + model.getId()).parentNode.style.top = ((Ext.Cat.MapConfig.MaxZoomLevel - obj.level) * 12 + 6) + "px"
        }
    }
});
...
SearchCmd.prototype = Object.extend(new Abstract.Command(), {
    ...
    searcher: function(mapDiv, model){
        ...
        this.selDiv1.innerHTML = '<div align="right" style="background:blue;padding:1px;cursor:default"><img onclick="hideInfoWindown(event, \'' + this.selDiv1.id + '\')" src="' + Ext.Cat.MapConfig.ImageBaseDir + 'infowindow_close.gif"></div>'      
        ...
        this.selDiv2.innerHTML = '<div align="right" style="background:blue;padding:1px;cursor:default"><img onclick="hideInfoWindown(event, \'' + this.selDiv2.id + '\')" src="' + Ext.Cat.MapConfig.ImageBaseDir + 'infowindow_close.gif"></div>'              
        ...
        this.searchDiv.innerHTML = '<div align="right" style="background:blue;padding:1px;cursor:default"><img onclick="hideInfoWindown(event, \'' + this.searchDiv.id + '\')" src="' + Ext.Cat.MapConfig.ImageBaseDir + 'infowindow_close.gif"></div>'
...
LocateCmd.prototype = Object.extend(new Abstract.Command(), {
    ...
    areaLocate: function(mapDiv, model){   
        ...
        this.areaDiv.innerHTML = '<div align="right" style="background:blue;padding:1px;cursor:default"><img onclick="hideInfoWindown(event, \'' + this.areaDiv.id + '\')" src="' + Ext.Cat.MapConfig.ImageBaseDir + 'infowindow_close.gif"></div>'
